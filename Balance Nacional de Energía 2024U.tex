...
\hypersetup{
  ...
  pdfsubject={BNE 2024},
  pdfkeywords={Energía},
  pdfcreationdate={D:20260218002326},
  pdfversion={1}
}
...
\setDocumentoCorto{Balance Nacional de Energía 2024U}
...
\begin{itemize}
  ...
  \item Comité Nacional para el Desarrollo Sustentable de la Caña de Azúcar (CONADESUCA).
...
\begin{tabladoradoCorto}
  ...
  \begin{tabularx}{\textwidth}{Vvvv}
    \toprule
\arrayrulecolor{gobmxAmbarClaro}
    \rowcolor{gobmxDorado} \encabezadodorado{CATEGORÍA} & \encabezadodorado{\SENERVHeader{ACEITE 
(MMb)}} & \encabezadodorado{\SENERVHeader{GAS 
(MMMpc)}} & \encabezadodorado{\SENERVHeader{PCE 
(MMbpce)}} \\
...
\begin{tabladoradoCorto}
  ...
  \begin{tabularx}{\textwidth}{Vvvv}
    \toprule
\arrayrulecolor{gobmxAmbarClaro}
    \rowcolor{gobmxDorado} \encabezadodorado{UBICACIÓN} & \encabezadodorado{\SENERVHeader{ASIGNACIONES}} & \encabezadodorado{\SENERVHeader{CONTRATOS}} & \encabezadodorado{\SENERVHeader{POZOS OPERANDO}} \\
\arrayrulecolor{black}
    \midrule
...
* Incluye aguas someras y profundas \par
\vspace{1pt}
{\color{gobmxGris} FUENTE:~Elaboración de SENER con información del Sistema de Información de Hidrocarburos, Rondas México y Portal de Asignaciones de la SENER}\hfill
\par}
\vspace{6pt}
...
\begin{tabladoradoCorto}
  ...
  \begin{tabularx}{\textwidth}{Vvv}
    \toprule
\arrayrulecolor{gobmxAmbarClaro}
    \rowcolor{gobmxDorado} \encabezadodorado{REFINERÍA} & \encabezadodorado{\SENERVHeader{UBICACIÓN}} & \encabezadodorado{\SENERVHeader{Mbd}} \\
\arrayrulecolor{black}
    \midrule
    ...
    \multicolumn{2}{c}{Sistema Nacional de Refinación} & 1,980 \\
    \bottomrule
  \end{tabularx}
\end{tabladoradoCorto}
\vspace{-4pt}
...
\begin{tabladoradoCorto}
  ...
  \begin{tabularx}{\textwidth}{Vvvvv}
    \toprule
\arrayrulecolor{gobmxAmbarClaro}
    \rowcolor{gobmxDorado} \encabezadodorado{COMPLEJO PROCESADOR DE GAS DE PEMEX} & \encabezadodorado{\SENERVHeader{ENDULZAMIENTO DE GAS
  (MMpcd)}} & \encabezadodorado{\SENERVHeader{ENDULZAMIENTO DE LÍQUIDOS (Mbd)}} & \encabezadodorado{\SENERVHeader{PROCESO CRIOGÉNICO (MMpcd)}} & \encabezadodorado{\SENERVHeader{FRACCIONAMIENTO DE LÍQUIDOS (Mbd)}} \\
\arrayrulecolor{black}
    \midrule
...
\begin{tabladoradoCorto}
  ...
  \begin{tabularx}{\textwidth}{Vvv}
    \toprule
\arrayrulecolor{gobmxAmbarClaro}
    \rowcolor{gobmxDorado} \encabezadodorado{COMPLEJOS PETROQUÍMICOS} & \encabezadodorado{\SENERVHeader{UBICACIÓN}} & \encabezadodorado{\SENERVHeader{CAPACIDAD Mt}} \\
\arrayrulecolor{black}
    \midrule
...
\begin{tabladoradoCorto}
  ...
  \begin{tabularx}{\textwidth}{Vvvvv}
    \toprule
\arrayrulecolor{gobmxAmbarClaro}
    \rowcolor{gobmxDorado} \encabezadodorado{PROCESO (Mt)} & \encabezadodorado{\SENERVHeader{LA CANGREJERA}} & \encabezadodorado{\SENERVHeader{COSOLEACAQUE}} & \encabezadodorado{\SENERVHeader{MORELOS}} & \encabezadodorado{\SENERVHeader{INDEPENDENCIA}} \\
\arrayrulecolor{black}
    \midrule
...
\begin{tabladoradoCorto}
  ...
  \begin{tabularx}{\textwidth}{Vvv}
    \toprule
\arrayrulecolor{gobmxAmbarClaro}
    \rowcolor{gobmxDorado} \encabezadodorado{SISTEMA INTEGRADO} & \encabezadodorado{\SENERVHeader{SISTEMA}} & \encabezadodorado{\SENERVHeader{LONGITUD
 (km)}} \\
\arrayrulecolor{black}
    \midrule
    \multirow{2}{*}{SISTRANGAS} & SNG & 8,386 \\
     & Gasoductos privados interconectados e integrados & 1,346 \\
    SNH & Sistema Naco-Hermosillo & 355 \\
    \multicolumn{2}{c}{Total} & 10,087 \\
    \bottomrule
  \end{tabularx}
\end{tabladoradoCorto}
\vspace{-4pt}
...
\begin{tabladoradoCorto}
  ...
  \begin{tabularx}{\textwidth}{Vv}
    \toprule
\arrayrulecolor{gobmxAmbarClaro}
    \rowcolor{gobmxDorado} \encabezadodorado{UBICACIÓN} & \encabezadodorado{\SENERVHeader{CAPACIDAD DE ALMACENAMIENTO
 (METROS CÚBICOS)}} \\
\arrayrulecolor{black}
    \midrule
...
\begin{tabladoradoCorto}
  ...
  \begin{tabularx}{\textwidth}{Vvv}
    \toprule
\arrayrulecolor{gobmxAmbarClaro}
    \rowcolor{gobmxDorado} \encabezadodorado{NACIONAL} & \encabezadodorado{\SENERVHeader{LONGITUD (KM)}} & \encabezadodorado{\SENERVHeader{CAPACIDAD NOMINAL (MBD)}} \\
\arrayrulecolor{black}
    \midrule
...
\begin{tabladoradoCorto}
  ...
  \begin{tabularx}{\textwidth}{Vvvv}
    \toprule
\arrayrulecolor{gobmxAmbarClaro}
    \rowcolor{gobmxDorado} \encabezadodorado{MODALIDAD} & \encabezadodorado{TERMINALES} & \multicolumn{2}{|c|}{\encabezadodorado{CAPACIDAD (MB)}} \\
\arrayrulecolor{black}
    \midrule
...
\begin{tabladoradoCorto}
  ...
  \begin{tabularx}{\textwidth}{Vvv}
    \toprule
\arrayrulecolor{gobmxAmbarClaro}
    \rowcolor{gobmxDorado} \encabezadodorado{MODALIDAD} & \encabezadodorado{\SENERVHeader{PERMISOS}} & \encabezadodorado{\SENERVHeader{CAPACIDAD (MB)}} \\
\arrayrulecolor{black}
    \midrule
...
\begin{tabladoradoCorto}
  ...
  \begin{tabularx}{\textwidth}{Vv}
    \toprule
\arrayrulecolor{gobmxAmbarClaro}
    \rowcolor{gobmxDorado} \encabezadodorado{TECNOLOGÍA} & \encabezadodorado{\SENERVHeader{CAPACIDAD (MW)}} \\
\arrayrulecolor{black}
    \midrule
...
\begin{tabladoradoCorto}
  ...
  \begin{tabularx}{\textwidth}{Vv}
    \toprule
\arrayrulecolor{gobmxAmbarClaro}
    \rowcolor{gobmxDorado} \encabezadodorado{NIVEL DE TENSIÓN} & \encabezadodorado{\SENERVHeader{LONGITUD (KM)}} \\
\arrayrulecolor{black}
    \midrule
...
\begin{tabladoradoCorto}
  ...
  \begin{tabularx}{\textwidth}{Vv}
    \toprule
\arrayrulecolor{gobmxAmbarClaro}
    \rowcolor{gobmxDorado} \encabezadodorado{NIVEL DE TENSIÓN} & \encabezadodorado{\SENERVHeader{CAPACIDAD DE TRANSFORMACIÓN (MVA) 2024}} \\
\arrayrulecolor{black}
    \midrule
...
\begin{tabladoradoCorto}
  ...
  \begin{tabularx}{\textwidth}{Vv}
    \toprule
\arrayrulecolor{gobmxAmbarClaro}
    \rowcolor{gobmxDorado} \encabezadodorado{INFRAESTRUCTURA DE DISTRIBUCIÓN} & \encabezadodorado{\SENERVHeader{2024}} \\
\arrayrulecolor{black}
    \midrule
...
\begin{tabladoradoCorto}
  ...
  \begin{tabularx}{\textwidth}{Vv}
    \toprule
\arrayrulecolor{gobmxAmbarClaro}
    \rowcolor{gobmxDorado} \multicolumn{2}{|c|}{\encabezadodorado{Capacidad instalada de Generación distribuida}} \\
\arrayrulecolor{black}
    \midrule
    Total (MW) & 4,447.90 \\
    Contratos (n°) & 518,019 \\
...
\entradaSigla{CPQ}{Complejo petroquimico}
...
\entradaGlosario{MW}{Megawhatt}
\entradaGlosario{Otra}{Prueba}
