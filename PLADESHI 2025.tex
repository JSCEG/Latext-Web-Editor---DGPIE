...
\hypersetup{
  ...
  pdfkeywords={Energía},
  pdfcreationdate={D:20260129000817},
  pdfversion={1}
}
...
\begin{tabladoradoCorto}
  \caption{TABLA 2.7. PRODUCCIÓN DE HIDROCARBUROS LÍQUIDOS POR PROVINCIA}
  \label{tab:TBL-2.2.2-1}
  \begin{tabularx}{\textwidth}{Vvv}
    \toprule
    \rowcolor{gobmxDorado} \encabezadodorado{PRODUCCIÓN DE HIDROCARBUROS LÍQUIDOS (MBD)} & \encabezadodorado{2023} & \encabezadodorado{2024} \\
    \midrule
    Cuencas del Sureste & 1,825 & 1,692 \\
    Veracruz & 55 & 81 \\
    Tampico Misantla & 54 & 47 \\
    Burgos & 2 & 1 \\
    Sabinas & - & - \\
    Total & 1,936 & 1,821 \\
    \bottomrule
