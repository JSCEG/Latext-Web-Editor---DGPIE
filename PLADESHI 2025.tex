...
\hypersetup{
  ...
  pdfkeywords={Energía},
  pdfcreationdate={D:20260128200647},
  pdfversion={1}
}
...
El sector de hidrocarburos constituye un componente fundamental del sistema energético nacional y un elemento esencial para la seguridad, la soberanía y la estabilidad económica del país. Su desarrollo ordenado y sustentable resulta indispensable para asegurar el abastecimiento energético, fortalecer la industria nacional y garantizar la continuidad de las actividades productivas que sustentan el bienestar de la población. En congruencia con los objetivos establecidos en el Plan Nacional de Desarrollo 2025–2030 (PND 2025–2030), el Gobierno de México impulsa una política energética integral que promueve el aprovechamiento eficiente y responsable que contribuye al fortalecimiento de la soberanía energética de la Nación. El Plan de Desarrollo del Sector de Hidrocarburos (en adelante, PLADESHi) es el instrumento de planeación de largo plazo previsto en la Ley de Planeación y Transición Energética (en adelante, LPTE), mediante el cual se orienta la expansión y modernización de la infraestructura del sector. Su propósito es prever y coordinar las acciones necesarias para garantizar el suministro oportuno, suficiente y sostenible de hidrocarburos y sus derivados, con un horizonte de planeación de quince años y revisiones anuales que permitan su adecuación a la evolución tecnológica, económica y ambiental del país. La elaboración del PLADESHi reconoce que los hidrocarburos continúan desempeñando un papel relevante en la matriz energética nacional durante el proceso de transición hacia el aprovechamiento de fuentes de energía más limpias y sostenibles. En este sentido, se establecen las directrices para optimizar la utilización de los recursos nacionales, incrementar la eficiencia de las operaciones, reducir las emisiones asociadas y fortalecer la seguridad energética bajo criterios de responsabilidad ambiental y social. Así, el PLADESHi articula, en un marco único de planeación, las acciones estratégicas de exploración, extracción, procesamiento, refinación, formulación, tratamiento, transporte, almacenamiento, distribución, expendio, comercialización de hidrocarburos, importación, exportación, así como la modernización de la infraestructura, el fortalecimiento tecnológico y la integración de cadenas de valor que impulsen la competitividad nacional. Conforme a lo establecido en la LPTE, la Secretaría de Energía (en adelante, SENER) conduce su elaboración y actualización, con la participación de las entidades y empresas públicas del Estado, particularmente Petróleos Mexicanos (en adelante, PEMEX) y sus empresas filiales, en coordinación con otros participantes del sector. El Plan se elabora con estricto apego a los principios de sustentabilidad, seguridad energética, eficiencia económica, equidad social y transparencia institucional, garantizando la coherencia de las políticas públicas en materia energética. En consistencia con el PND 2025–2030, el PLADESHi se sustenta en los siguientes principios rectores: ● Soberanía y seguridad energética, mediante el fortalecimiento de la producción nacional, la confiabilidad del suministro y la reducción de la dependencia externa. ● Eficiencia y modernización del sector, promoviendo la innovación tecnológica, la mejora continua de los procesos y la reducción de pérdidas. ● Transición energética ordenada y sustentable, que impulse la descarbonización progresiva y el aprovechamiento más limpio de los hidrocarburos. ● Desarrollo productivo y regional, orientado a generar valor agregado nacional, empleo digno y encadenamientos industriales estratégicos. ● Transparencia, rendición de cuentas y gobernanza institucional, que consoliden la legitimidad de las decisiones públicas y la participación informada de la sociedad. El PLADESHi representa un instrumento de Estado que orienta la política pública y las inversiones estratégicas en el país en materia de hidrocarburos. Constituye, al mismo tiempo, una expresión del compromiso del Gobierno de México con la seguridad energética, la soberanía nacional y la transición hacia un sistema energético con infraestructura moderna, eficiente y sostenible, en beneficio del pueblo de México.
...
● Fortalecimiento de PEMEX y la Comisión Federal de Electricidad (CFE) como empresas públicas del Estado.

● La producción de PEMEX priorizará el consumo nacional.

● Fuerte impulso a la eficiencia y racionalidad energéticas.
...
● 4.2.1 Fomentar la transición gradual de combustibles fósiles a energías renovables para fortalecer la sustentabilidad económica y ambiental.

● 4.2.3 Fomentar el aprovechamiento eficiente y sustentable de los recursos energéticos para fortalecer la seguridad energética y reducir el impacto ambiental.

● 4.2.4 Promover la integración de energías limpias y renovables en todas las etapas de las cadenas de valor para garantizar un suministro energético sustentable y competitivo.

● 4.3.1. Reducir las emisiones de gases de efecto invernadero para mitigar el cambio climático y sus impactos en la sociedad, la economía y el medio ambiente.

● 4.3.2. Implementar políticas de mitigación y adaptación al cambio climático con enfoque en derechos humanos, igualdad y justicia ambiental para fortalecer la resiliencia de la sociedad y los ecosistemas.

● 4.4.1. Desarrollar esquemas que amplíen el acceso a la energía en comunidades y regiones con pobreza energética, garantizando un suministro confiable, asequible y sustentable.

● 4.4.2 Garantizar el suministro de electricidad y combustibles a toda la población mediante mecanismos de ajuste de precios que aseguren su asequibilidad y estabilidad.

● 4.4.3 Facilitar trámites y procesos administrativos para comunidades rurales e industrias con infraestructura de autoabastecimiento energético, asegurando un acceso eficiente y sustentable a la energía.
...
● Plan Estratégico 2025- 2035 de Petróleos Mexicanos.

● Plan de Sustentabilidad de Petróleos Mexicanos.

Para la elaboración del PLADESHi, la SENER también considera las siguientes definiciones:

● Exploración eficiente: optimizar los procesos para identificar nuevas reservas de petróleo y gas.

● Producción sustentable: implementar prácticas responsables con el medio ambiente para asegurar una producción sostenible.

● Refinación reforzada: mejorar la capacidad y eficiencia de las refinerías existentes y construir nuevas infraestructuras.

● Producción de petroquímicos y fertilizantes: aumentar la producción de estos productos esenciales.

● Logística segura y eficiente: modernizar los sistemas de transporte y distribución para garantizar un suministro continuo y seguro.

● Generación de energía limpia: integrar fuentes de energía renovable para diversificar la matriz energética del país.

● Eficiencia Energética: Todas las acciones que conlleven a una reducción, económicamente viable, de la cantidad de energía que se requiere para satisfacer las necesidades energéticas de los servicios y bienes que demanda la sociedad, asegurando un nivel de servicio igual o superior.
...
Durante el 2025, PEMEX participó en la inauguración de nuevas Gasolineras del Bienestar en los estados de Puebla y Chihuahua, que se suman a las instaladas en Campeche y Oaxaca \cite{p}.
...
\begin{figure}[H]
  ...
  \pdftooltip{\includegraphics[width=1.0\textwidth]{img/figura_2_1.png}}{Figura 2.1. Provincia Petroleras de la República Mexicana}
  \par}
  \raggedright
  \caption{Figura 2.1. Provincia Petroleras de la República Mexicana}
...
\begin{tabladoradoCorto}
  ...
  \begin{tabularx}{\textwidth}{Vvvv}
    \toprule
    \rowcolor{gobmxDorado} \encabezadodorado{CUENCA } & \encabezadodorado{PEMEX} & \encabezadodorado{CONTRATISTAS} & \encabezadodorado{TOTAL GENERAL} \\
    \midrule
    Burgos & 40 & 14 & 54 \\
    Cinturón Plegado de Chiapas & 3 & 2 & 5 \\
    Cuencas del Sureste & 260 & 50 & 310 \\
    Golfo de México Profundo & 53 & 29 & 82 \\
    Plataforma de Yucatán & 1 &  & 1 \\
    Sabinas-Burro-Picachos & 14 &  & 14 \\
    Tampico-Misantla & 38 & 5 & 43 \\
    Veracruz & 43 & 5 & 48 \\
    Total general & 452 & 105 & 557 \\
    \bottomrule
  \end{tabularx}
...
\begin{tabladoradoCorto}
  ...
  \begin{tabularx}{\textwidth}{Vvvv}
    \toprule
    \rowcolor{gobmxDorado} \encabezadodorado{ASIGNACIONES} & \encabezadodorado{} & \encabezadodorado{} & \encabezadodorado{CONTRATOS} \\
    \midrule
    Extracción
(A) & Exploración (AE) & Resguardo
(AR) & Producción Compartida \\
    258 & 111 & 43 & 29 \\
    TOTAL: 412 &  &  & TOTAL: 104 \\
    \bottomrule
  \end{tabularx}
...
\begin{tabladoradoCorto}
  ...
  \begin{tabularx}{\textwidth}{Vvvvvvvvv}
    \toprule
    \rowcolor{gobmxDorado} \encabezadodorado{UBICACIÓN / PROVINCIA} & \encabezadodorado{BURGOS} & \encabezadodorado{CINTURÓN PLEGADO DE CHIAPAS} & \encabezadodorado{CUENCAS DEL SURESTE} & \encabezadodorado{GOLFO DE MÉXICO PROFUNDO} & \encabezadodorado{SABINAS BURRO PICACHO} & \encabezadodorado{TAMPICO MISANTLA} & \encabezadodorado{VERACRUZ} & \encabezadodorado{TOTAL} \\
    \midrule
    Terrestre & 183 & 23.7 & 36.9 & 0 & 0 & 0 & 0 & 0 \\
    Aguas Someras & - & - & 1.4 &  & - &  & - &  \\
    Aguas Profundas & - & - & - &  & - & - & - &  \\
    Total general & 79 & 2 & 169 & 22 & 2 & 84 & 54 & 412 \\
    \bottomrule
  \end{tabularx}
\end{tabladoradoCorto}
\vspace{-4pt}
...
\begin{tabladoradoCorto}
  ...
  \begin{tabularx}{\textwidth}{Vvv}
    \toprule
    \rowcolor{gobmxDorado} \encabezadodorado{TIPO DE CONTRATO} & \encabezadodorado{UBICACIÓN} & \encabezadodorado{NÚMERO DE CONTRATOS} \\
    \midrule
    Licencia & Aguas profundas & 23 \\
     & Terrestre & 48 \\
    Producción Compartida & Aguas someras & 30 \\
     & Terrestre & 3 \\
    Total general &  & 104 \\
    \bottomrule
  \end{tabularx}
...
Estos 112.9 MMMbpce representan la suma del potencial identificado tanto en petróleo crudo, estimado en 68 mil millones de barriles (MMMb) de petróleo crudo , integrados por 32.1 MMMb de Recursos Convencionales y 35.9 MMMb de Recursos no Convencionales y 224.7 Billones de pies cúbicos\footnote{Se refiere a 1x10\textasciicircum{}12 pies cúbicos.} de gas natural (MMMMpc) estimados como recurso prospectivo, de los cuales 83.2 MMMMpc son Recursos Convencionales y 141.5 MMMMpc Recursos no Convencionales.
...
\begin{tabladoradoCorto}
  ...
  \begin{tabularx}{\textwidth}{Vvv}
    \toprule
    \rowcolor{gobmxDorado} \encabezadodorado{DISTRIBUCIÓN DE LOS RECURSOS} & \encabezadodorado{ÁREAS} & \encabezadodorado{RECURSOS PROSPECTIVOS (MMMbpce)} \\
    \midrule
     &  & CONVENCIONAL \\
    Asignaciones & 412 & 14.6 \\
    Contratos de Exploración y Extracción & 104 & 10.4 \\
    Áreas del Estado & 183 & 23.7 \\
    \bottomrule
  \end{tabularx}
\end{tabladoradoCorto}
\vspace{-4pt}
...
\begin{figure}[H]
  {\centering
  % Texto alternativo para accesibilidad
  \pdftooltip{\includegraphics[width=1.0\textwidth]{img/figura_2_12.png}}{Figura 2.12. Histórico reservas probadas, probables y posibles de gas natural de la Nación}
  \par}
  \raggedright
...
● La incorporación del campo Trión en las Reservas 3P de la Nación con 630.2 MMbpce.
● La incorporación de Reservas 3P de los campos Bakte, Etkal-NE y Macuil con 172.9 MMbpce, 54.5 MMbpce y 50.4 MMbpce, respectivamente.
● El incremento en las Reservas 3P por motivos de revisiones técnicas de los campos Ixachi (con 139.6 MMbpce) y Zaap (94.0 MMbpce).
● La reducción en las Reservas 3P del campo Quesqui (en 114.4 MMbpce) por la disminución de presión y producción, así como el campo Ku (en 76.3 MMbpce), debido principalmente a la mayor declinación en la producción por incremento en el corte de agua.
...
\begin{tabladoradoCorto}
  ...
  \begin{tabularx}{\textwidth}{Vvv}
    \toprule
    \rowcolor{gobmxDorado} \encabezadodorado{TIPO} & \encabezadodorado{LONGITUD (KM)} & \encabezadodorado{(\%)} \\
    \midrule
    Gasoductos & 5,518 & 25\% \\
    Oleoductos & 3,041 & 14\% \\
    Oleogasoductos & 2,623 & 12\% \\
    Gasolinoductos & 337 & 2\% \\
    Ductos de Transporte e Inyección de agua & 190 & 1\% \\
    Líneas de Descarga & 9,397 & 42\% \\
    Líneas de Bombeo Neumático & 989 & 4\% \\
    Otros & 192 & 1\% \\
    Total & 22,288 & 100\% \\
    \bottomrule
  \end{tabularx}
...
\begin{tabladoradoCorto}
  ...
  \begin{tabularx}{\textwidth}{Vvv}
    \toprule
    \rowcolor{gobmxDorado} \encabezadodorado{PRODUCCIÓN DE GAS NATURAL (MMPCD)} & \encabezadodorado{2023} & \encabezadodorado{2024} \\
    \midrule
    Cuencas del Sureste & 3,285 & 2,653 \\
    Veracruz & 439 & 615 \\
    Burgos & 481 & 410 \\
    Tampico Misantla & 93 & 78 \\
    Sabinas & 4 & 3 \\
    Total & 4,301 & 3,759 \\
    \bottomrule
  \end{tabularx}
...
\begin{tabladoradoCorto}
  ...
  \begin{tabularx}{\textwidth}{Vvv}
    \toprule
    \rowcolor{gobmxDorado} \encabezadodorado{} & \encabezadodorado{INICIO DE OPERACIONES} & \encabezadodorado{REGIÓN DE ABASTECIMIENTO} \\
    \midrule
    Salamanca & 1950 & Centro-Occidente \\
    Minatitlán & 1956 & Sur-Sureste \\
    Madero & 1960 & Noreste \\
    Tula & 1977 & Centro \\
    Salina Cruz & 1979 & Sur-Sureste \\
    Cadereyta & 1979 & Noreste \\
    Olmeca & 2024 & Sureste \\
    \bottomrule
  \end{tabularx}
\end{tabladoradoCorto}
...
\begin{tabladoradoCorto}
  ...
  \begin{tabularx}{\textwidth}{Vvvvvvvv}
    \toprule
    \rowcolor{gobmxDorado} \encabezadodorado{MBD} & \encabezadodorado{CADEREYTA} & \encabezadodorado{MADERO} & \encabezadodorado{OLMECA} & \encabezadodorado{MINATITLÁN} & \encabezadodorado{SALAMANCA} & \encabezadodorado{SALINA CRUZ} & \encabezadodorado{TULA} \\
    \midrule
    Destilación
Atmosférica & 275 & 190 & 340 & 285 & 245 & 330 & 315 \\
    Destilación
al Vacío & 124 & 91 & 176 & 129 & 119 & 165 & 144 \\
    Desintegración & 90 & 61 & 94 & 72 & 40 & 80 & 80 \\
    Reducción
de Viscosidad & - & - & 130 & - & - & 50 & 41 \\
    Reformación
de Naftas & 46 & 30 & 82 & 49 & 39 & 50 & 65 \\
    Hidrodesulfuración & 229 & 182 & 350 & 213 & 142 & 215 & 249 \\
    Alquilación
e Isomerización & 23 & 22 & 48 & 42 & 14 & 28 & 25 \\
    Coquización & 50 & 50 & 130 & 56 & - & - & - \\
    \bottomrule
  \end{tabularx}
\end{tabladoradoCorto}
\vspace{-4pt}
...
● 35.61\% se centró en la obtención de Gasolina
● 33.35\% en Combustóleo
● 22.11\% en Diésel
● 4.81\% en Coque de Petróleo
● 4.12\% en Turbosina
...
\begin{tabladoradoCorto}
  ...
  \begin{tabularx}{\textwidth}{Vvv}
    \toprule
    \rowcolor{gobmxDorado} \encabezadodorado{} & \encabezadodorado{INICIO DE OPERACIONES} & \encabezadodorado{UBICACIÓN} \\
    \midrule
    Poza Rica & 1951 & Poza Rica, Veracruz \\
    Ciudad Pemex & 1958 & Macuspana, Tabasco \\
    La Venta & 1963 & Huímanguillo, Tabasco \\
    Cactus & 1974 & Reforma, Chiapas \\
    Nuevo Pemex & 1976 & Centro, Tabasco \\
    Matapionche & 1981 & Cotaxtla, Veracruz \\
    Coatzacoalcos & 1997 & Coatzacoalcos, Veracruz \\
    Arenque & 2003 & Ciudad Madero, Tamaulipas \\
    Burgos & 2004 & Reynosa, Tamaulipas \\
    \bottomrule
  \end{tabularx}
\end{tabladoradoCorto}
\vspace{-4pt}
...
\begin{tabladoradoCorto}
  ...
  \begin{tabularx}{\textwidth}{Vvvvv}
    \toprule
    \rowcolor{gobmxDorado} \encabezadodorado{} & \encabezadodorado{FRACCIONAMIENTO DE LÍQUIDOS
(MBD)} & \encabezadodorado{PLANTAS ENDULZADORAS DE CONDENSANDOS AMARGOS
(MBD)} & \encabezadodorado{PLANTAS ENDULZADORAS DE GAS AMARGO
(MMPCD)} & \encabezadodorado{PLANTAS RECUPERADORAS DE LICUABLES CRIOGÉNICAS
(MMPCD)} \\
    \midrule
    CACTUS & 104 & 45 & 1,800 & 1,275 \\
    CIUDAD PEMEX & 0 & 0 & 1,290 & 915 \\
    NUEVO PEMEX & 208 & 90 & 800 & 1,500 \\
    BURGOS & 18 & 0 & 0 & 1,200 \\
    POZA RICA & 22 & 0 & 250 & 490 \\
    LA VENTA & 0 & 0 & 0 & 182 \\
    ARENQUE & 0 & 0 & 34 & 33 \\
    MATAPIONCHE & 0 & 0 & 109 & 125 \\
    COATZACOALCOS & 208 & 0 & 0 & 192 \\
    TOTAL & 560 & 135 & 4,283 & 5,912 \\
    \bottomrule
  \end{tabularx}
\end{tabladoradoCorto}
\vspace{-4pt}
...
\begin{tabladoradoCorto}
  ...
  \begin{tabularx}{\textwidth}{Vv}
    \toprule
    \rowcolor{gobmxDorado} \encabezadodorado{} & \encabezadodorado{INICIO DE OPERACIONES} \\
    \midrule
    Independencia & 1969 \\
    Cosoleacaque & 1971 \\
    La Cangrejera & 1980 \\
...
\begin{tabladoradoCorto}
  ...
  \begin{tabularx}{\textwidth}{Vvvvv}
    \toprule
    \rowcolor{gobmxDorado} \encabezadodorado{MT} & \encabezadodorado{LA CANGREJERA} & \encabezadodorado{COSOLEACAQUE} & \encabezadodorado{MORELOS} & \encabezadodorado{INDEPENDENCIA} \\
    \midrule
...
\begin{tabladoradoCorto}
  ...
  \begin{tabularx}{\textwidth}{Vvvv}
    \toprule
    \rowcolor{gobmxDorado} \encabezadodorado{PERMISIONARIO} & \encabezadodorado{UBICACIÓN} & \encabezadodorado{CAPACIDAD DE ALMACENAMIENTO
 (METROS CÚBICOS)} & \encabezadodorado{AÑO DE INICIO DE OPERACIONES} \\
    \midrule
    ENERGÍA COSTA AZUL & ENSENADA, BAJA CALIFORNIA & 320,000 & 2008 \\
    TERMINAL DE LNG DE ALTAMIRA & ALTAMIRA, TAMAULIPAS & 300,000 & 2006 \\
    TERMINAL KMS & MANZANILLO, COLIMA & 300,000 & 2012 \\
    MEXICO FLNG & ALDAMA, TAMAULIPAS & 160,683 & 2024 \\
    NFE PACIFICO & PICHILINGUE, BAJA CALIFORNIA SUR & 145,954 & 2023 \\
    \bottomrule
  \end{tabularx}
\end{tabladoradoCorto}
\vspace{-4pt}
...
\begin{tabladoradoCorto}
  ...
  \begin{tabularx}{\textwidth}{Vvv}
    \toprule
    \rowcolor{gobmxDorado} \encabezadodorado{} & \encabezadodorado{LONGITUD (KM)} & \encabezadodorado{CAPACIDAD (MBD) \textsuperscript{\hyperlink{nota2}{\textcolor{white}{2/}}}} \\
    \midrule
    TRANSPORTE DE PETROLÍFEROS LÍQUIDOS \textsuperscript{\hyperlink{nota1}{\textcolor{black}{1/}}} & 9,582 & 4,586 \\
    \bottomrule
  \end{tabularx}
\end{tabladoradoCorto}
\vspace{-4pt}
...
\begin{tabladoradoCorto}
  ...
  \begin{tabularx}{\textwidth}{Vvvvvv}
    \toprule
    \rowcolor{gobmxDorado} \encabezadodorado{UBICACIÓN} & \encabezadodorado{PERMISIONARIO} & \encabezadodorado{DIÁMETRO
(PLG)} & \encabezadodorado{LONGITUD 
(KM)} & \encabezadodorado{CAPACIDAD 
(MB)} & \encabezadodorado{AÑO DE INICIO DE VIGENCIA DEL PERMISO} \\
    \midrule
    POZA RICA – ATOTONILCO – SANTIAGO & DUCTOS DEL ALTIPLANO, S. A. DE C. V. & 14 & 285 & 35 & 2006 \\
    CACTUS - GUADALAJARA & PEMEX LOGÍSTICA & 20 & 1,539 & 240 & 2010 \\
    HOBBS – MÉNDEZ & PEMEX LOGÍSTICA & 8 & 35 & 24 & 2006 \\
    CPG BURGOS – MONTERREY & TDF, S. DE R.L. DE C. V. & 12 & 185 & 34 & 2006 \\
    \bottomrule
  \end{tabularx}
\end{tabladoradoCorto}
\vspace{-4pt}
...
\begin{tabladoradoCorto}
  ...
  \begin{tabularx}{\textwidth}{Vvvv}
    \toprule
    \rowcolor{gobmxDorado} \encabezadodorado{PERMISIONARIO} & \encabezadodorado{LONGITUD 
(KM)} & \encabezadodorado{CAPACIDAD 
(MB)} & \encabezadodorado{AÑO DE INICIO DE VIGENCIA DEL PERMISO} \\
    \midrule
    COMPAÑÍA DE GAS DE TIJUANA, S. A. DE C. V. & 189 & 1,179 & 2006 \\
    GAS DEL CARIBE, S. A. DE C. V. & 127 & 1,129 & 2010 \\
    ASOCIACIÓN DE COLONOS DE LA HERRADURA, A. C. & 37 & 272 & 2006 \\
    \bottomrule
  \end{tabularx}
\end{tabladoradoCorto}
\vspace{-4pt}
...
\begin{tabladoradoCorto}
  ...
  \begin{tabularx}{\textwidth}{Vvvvvv}
    \toprule
    \rowcolor{gobmxDorado} \encabezadodorado{PERMISIONARIO} & \encabezadodorado{PETROQUÍMICO} & \encabezadodorado{LONGITUD 
(KM)} & \encabezadodorado{DIÁMETRO 
(PLG)} & \encabezadodorado{CAPACIDAD } & \encabezadodorado{UBICACIÓN} \\
    \midrule
    Gasoductos del Sureste  & Etano Gas & 5.2​ & 20​ & 52.5 & CPG Coatzacoalcos - Complejo Braskem Idesa​ \\
     &  & 13.1​ & 16​ & 105 & CPG Nuevo PEMEX y Cactus - kilómetro 3 del ducto Cactus - Complejo Braskem Idesa​ \\
     &  & 3.9​ & 20​ & 151.9 & Ducto Cactus - Complejo Braskem Idesa​ \\
     &  & 130​ & 24​ &  &  \\
    Gasoductos del Sureste ​ & Etano Líquido & 80​ & 20​ & 105.6 & CPG Ciudad PEMEX - Nuevo PEMEX​ \\
    PEMEX Logística​ & Isobutano & 29​ & 20 y 8​ & 25 & Terminal Marítima Pajaritos - Refinería Minatitlán​ \\
     &  & 249​ & 6.6​ & 7 & Refinería Minatitlán - Refinería Salina Cruz​ \\
    PEMEX Logística​ & Nafta & 23 & 8 & 24.7 & CPG Burgos - Válvula de Peñitas​ \\
    Terminal Química Puerto México & Etano & 9.850​ & 12​ & 80 Mbd​ & Zona industrial de La Laguna Pajaritos - Terminal Puerto México (Veracruz)​ \\
    \bottomrule
  \end{tabularx}
\end{tabladoradoCorto}
\vspace{-4pt}
...
\begin{tabladoradoCorto}
  ...
  \begin{tabularx}{\textwidth}{Vvvvvv}
    \toprule
    \rowcolor{gobmxDorado} \encabezadodorado{TERMINAL DE ALMACENAMIENTO} & \encabezadodorado{PERMISIONARIO} & \encabezadodorado{UBICACIÓN} & \encabezadodorado{PETROQUÍMICO} & \encabezadodorado{NÚMERO DE TANQUES} & \encabezadodorado{CAPACIDAD TOTAL
(MB)} \\
    \midrule
    TERMINAL QUÍMICA PUERTO MÉXICO & Terminal Química Puerto México, S.A.P.I. De C.V. & Coatzacoalcos, Veracruz & Etano & 2 & 682 \\
    TERMINAL DE MARÍTIMA PAJARITOS & PEMEX Logística & Coatzacoalcos, Veracruz & Propano & 4 & 764 \\
     &  &  & Butano & 2 & 390 \\
     &  &  & Isobutano & 1 & 5 \\
    \bottomrule
  \end{tabularx}
...
\begin{tabladoradoCorto}
  ...
  \begin{tabularx}{\textwidth}{Vvvvvvvv}
    \toprule
    \rowcolor{gobmxDorado} \encabezadodorado{} & \encabezadodorado{2019} & \encabezadodorado{2020} & \encabezadodorado{2021} & \encabezadodorado{2022} & \encabezadodorado{2023} & \encabezadodorado{2024} & \encabezadodorado{PROMEDIO} \\
    \midrule
    INYECCIÓN & 4,988 & 4,564 & 5,015 & 4,995 & 4,782 & 4,862 & 4,868 \\
    \bottomrule
  \end{tabularx}
\end{tabladoradoCorto}
\vspace{-4pt}
...
En el caso del transporte de petrolíferos, entre 2010 y 2020 el volumen de petrolíferos transportados por PEMEX se redujo 38.8\%, como resultado de las dificultades del proceso logístico para la asignación presupuestaria adecuada. Al respecto, entre 2015 y 2019, el presupuesto de logística de PEMEX se redujo 78\% \cite{o}.

Sin embargo, a partir de 2019, el presupuesto de PEMEX destinado a la operación, registró un incremento como resultado de un cambio estratégico enfocado en el mantenimiento y la eficiencia de la infraestructura existente, en lugar de la expansión de nuevas instalaciones \cite{o}. Por ello, el volumen de petrolíferos transportados aumentó 30.4\% entre 2020 y 2024 (Figura 2.46).
...
\begin{tabladoradoLargo}
  ...
  \begin{xltabular}{\textwidth}{QZZZZZZZZZZZZZZ}
    \caption{TABLA 2.23 DEMANDA NACIONAL DE PETROLÍFEROS LÍQUIDOS, 2010-2024*}\label{tab:tabla_2_23_demanda_nacional_de}\\
    \toprule
    \rowcolor{gobmxDorado} \encabezadodorado{MBD} & \encabezadodorado{\SENERVHeader{2010}} & \encabezadodorado{\SENERVHeader{2011}} & \encabezadodorado{\SENERVHeader{2012}} & \encabezadodorado{\SENERVHeader{2013}} & \encabezadodorado{\SENERVHeader{2014}} & \encabezadodorado{\SENERVHeader{2015}} & \encabezadodorado{\SENERVHeader{2016}} & \encabezadodorado{\SENERVHeader{2017}} & \encabezadodorado{\SENERVHeader{2018}} & \encabezadodorado{\SENERVHeader{2019}} & \encabezadodorado{\SENERVHeader{2020}} & \encabezadodorado{\SENERVHeader{2021}} & \encabezadodorado{\SENERVHeader{2022}} & \encabezadodorado{\SENERVHeader{2023}} \\
    \midrule
    \endfirsthead
    ...
    \midrule
    \multicolumn{15}{r}{\small\textit{Continúa en la siguiente página...}} \\
    \endfoot

    \bottomrule
    \endlastfoot

    GASOLINAS \textsuperscript{\hyperlink{nota1}{\textcolor{black}{1/}}} & 803 & 800 & 804 & 787 & 777 & 793 & 823 & 799 & 787 & 800 & 686 & 740 & 800 & 790 \\
    DIÉSEL \textsuperscript{\hyperlink{nota2}{\textcolor{black}{2/}}} & 371 & 384 & 401 & 392 & 389 & 385 & 387 & 385 & 387 & 376 & 302 & 301 & 396 & 383 \\
    TURBOSINA & 56 & 56 & 59 & 62 & 67 & 71 & 76 & 82 & 86 & 87 & 48 & 69 & 88 & 93 \\
    COMBUSTÓLEO \textsuperscript{\hyperlink{nota3}{\textcolor{black}{3/}}} & 185 & 201 & 214 & 189 & 122 & 127 & 118 & 147 & 137 & 81 & 55 & 78 & 68 & 75 \\
    TOTAL & 1,415 & 1,441 & 1,478 & 1,431 & 1,354 & 1,376 & 1,405 & 1,413 & 1,396 & 1,344 & 1,092 & 1,189 & 1,352 & 1,341 \\
  \end{xltabular}

  \clearpage
  {\small\textit{Continuación Tabla. TABLA 2.23 DEMANDA NACIONAL DE PETROLÍFEROS LÍQUIDOS, 2010-2024*}}
  \vspace{0.15em}

  \setlength{\SENERLongTableFirstColWidth}{0.34\textwidth}
  \begin{xltabular}{\textwidth}{QZ}
    \toprule
    \rowcolor{gobmxDorado} \encabezadodorado{MBD} & \encabezadodorado{\SENERVHeader{2024}} \\
    \midrule
    \endfirsthead
    ...
    GASOLINAS \textsuperscript{\hyperlink{nota1}{\textcolor{black}{1/}}} & 793 \\
    DIÉSEL \textsuperscript{\hyperlink{nota2}{\textcolor{black}{2/}}} & 365 \\
    TURBOSINA & 94 \\
    COMBUSTÓLEO \textsuperscript{\hyperlink{nota3}{\textcolor{black}{3/}}} & 59 \\
    TOTAL & 1,311 \\
  \end{xltabular}
...
● Entre 2011 y 2013, el precio de la MME se encontraba en niveles que oscilaron alrededor de los 100 dólares por barril (USD/b), comportamiento relacionado con una fuerte demanda mundial de petróleo, especialmente de mercados emergentes como China y países de Medio Oriente \cite{d}. Asimismo se presentaron diversos eventos geopolíticos que originaron incertidumbre en los mercados y también influyeron en los precios \cite{d}.

● Para el periodo comprendido de finales de 2014 y 2015 se presentó una etapa de ajuste en los precios internacionales del crudo, vinculado a la reducción en el ritmo de crecimiento de la demanda, así como a la creciente oferta de crudo shale\footnote{Es un tipo de petróleo no convencional que se encuentra atrapado en formaciones rocosas de grano muy fino y baja permeabilidad, conocidas como lutitas o esquistos bituminosos (shale, en inglés).} de los Estados Unidos, y la decisión de la Organización de Países Exportadores de Petróleo (OPEP) de no reducir la producción en respuesta a la caída de los precios \cite{t}.

● En 2020, la declaración de la pandemia por el virus SARS-CoV-2 y las medidas implantadas en prácticamente todo el mundo, redujeron la demanda energética y favorecieron la caída en la actividad económica.

● En 2022 el precio de la MME alcanzó nuevos máximos resultado de los efectos de la invasión de Rusia a Ucrania que generó una alta incertidumbre sobre el suministro de energía ruso en el mercado internacional. No obstante, en 2023 el petróleo ruso encontró destinos fuera de la Unión Europea (UE) y la demanda mundial de crudo no alcanzó las expectativas, por lo que los precios del crudo volvieron a reducirse \cite{i}.

● En 2024, el crecimiento mundial de la producción de petróleo y la desaceleración del crecimiento de la demanda ejercieron presión a la baja sobre los precios, mientras que el aumento de los riesgos geopolíticos y las restricciones de la producción entre los miembros de la OPEP, mantuvieron los precios del petróleo dentro de un rango de variación estrecho \cite{k}.
...
● En 2019 el crecimiento sostenido de la producción de gas natural en Estados Unidos, ejerció presión a la baja sobre los precios \cite{f}. Esta tendencia se vio reforzada en 2020, a medida que los efectos económicos derivados de la pandemia de COVID-19 redujeron la demanda de gas natural.

● En febrero de 2021, una ola de frío que afectó gran parte del centro de Estados Unidos\footnote{La disminución en la producción de gas natural se debió principalmente a la congelación del agua y otros líquidos presentes en el flujo de gas natural crudo, que se produce cuando el agua y otros líquidos se congelan en la boca del pozo o en las tuberías de recolección cercanas a las áreas de producción.}, causó una caída en la producción de gas seco en ese país. La escasez afectó el suministro en México, por lo que se declaró en estado de alerta Crítica en el SISTRANGAS \cite{a}. La anterior impactó al alza los precios del energético de manera transitoria en dicho mes, alcanzando en México un nivel promedio de 21.37 dólares estadounidenses por millón de unidades térmicas británicas (USD/MMbtu).

● En 2022, los precios del gas seco se elevaron. Eventos en Estados Unidos, tales como suspensiones en la producción, importantes extracciones de gas natural almacenado, así como alta demanda para la generación de electricidad, derivada de las condiciones climáticas, fueron determinantes. Otro factor relevante fue el aumento de la demanda internacional de gas natural licuado estadounidense, originado por el crecimiento de las economías de Asia y las restricciones a las exportaciones de gas natural licuado ruso a Europa \cite{g}.

● En 2023 y 2024 los precios del gas seco se han visto beneficiados por el sólido suministro de Estados Unidos y un lento crecimiento del consumo.
...
\begin{figure}[H]
  {\centering
  % Texto alternativo para accesibilidad
  \pdftooltip{\includegraphics[width=1.0\textwidth]{img/figura_2_69-1.png}}{Figura 2.69. Precios de venta al público de petrolíferos, 2017-2024}
  \par}
  \raggedright
...
\begin{figure}[H]
  {\centering
  % Texto alternativo para accesibilidad
  \pdftooltip{\includegraphics[width=1.0\textwidth]{img/figura_2_69-2.png}}{Figura 2.69. Precios de venta al público de petrolíferos, 2017-2024}
  \par}
  \raggedright
\end{figure}
\vspace{-4pt}
...
Con relación al precio de la turbosina, entre enero de 2017 y junio de 2021 éste incrementó 87.7\% en términos reales, alcanzando en junio de 2022 su precio máximo. Esto se debió al aumento del precio de referencia en Estados Unidos, que se vio afectado por una oferta escasa del combustible e inferiores niveles de inventarios en Estados Unidos, así como interrupciones en el comercio mundial de petróleo tras la invasión de Rusia a Ucrania \cite{h}. Posteriormente, de junio de 2022 a diciembre de 2024, el precio en México de la turbosina se ha reducido 47\% en términos reales, dado que el precio internacional de referencia se redujo ante una mayor producción y la mejora en los niveles de inventarios en Estados Unidos.
...
● En años recientes se han implementado medidas de mitigación y aprovechamiento de gas, lo que ha permitido reducir la intensidad de emisiones.

● En los pozos nuevos se ha incorporado infraestructura para el manejo y aprovechamiento de gas; sin embargo, para maximizar este aprovechamiento es necesario contar con la totalidad de la infraestructura requerida desde el inicio de las operaciones.

● La cercanía al fin de la vida útil de algunos pozos ha requerido la inyección de nitrógeno para mantener la producción, lo que reduce la eficiencia de los equipos para el manejo del gas.
...
● La puesta en operación de algunas plantas rehabilitadas, que han permitido incrementar el proceso de crudo, generó desviaciones en la eficiencia operativa durante su periodo de estabilización.

● Se requieren recursos adicionales para la puesta en marcha de equipos auxiliares —como compresores y sistemas de endulzamiento de gas— para reducir los volúmenes de desfogues.

● A futuro, se busca continuar mejorando mediante la incorporación de tecnologías como sistemas de recuperación de gases que permitan aumentar la eficiencia y el aprovechamiento de hidrocarburos en las refinerías.
...
● En años recientes se han implementado medidas de mitigación y aprovechamiento de gas mediante la rehabilitación de plantas y sistemas de compresión, lo que ha permitido disminuir la intensidad de emisiones.

● Se prevé atender de manera integral el programa de mantenimiento de los equipos que permiten mantener el aprovechamiento del gas, así como de sus sistemas de respaldo.
...
● Las emisiones asociadas a las actividades de logística se han mantenido relativamente estables en los últimos años.
...
\begin{tabladoradoCorto}
  ...
  \label{tab:TBL-3.1-1}
  \begin{tabularx}{\textwidth}{Vvvvvvvvvvvvvvv}
    \toprule
    \rowcolor{gobmxDorado} \encabezadodorado{MMBPCE} & \encabezadodorado{2026} & \encabezadodorado{2027} & \encabezadodorado{2028} & \encabezadodorado{2029} & \encabezadodorado{2030} & \encabezadodorado{2031} & \encabezadodorado{2032} & \encabezadodorado{2033} & \encabezadodorado{2034} & \encabezadodorado{2035} & \encabezadodorado{2036} & \encabezadodorado{2037} & \encabezadodorado{2038} & \encabezadodorado{2039} \\
    \midrule
    Esc. de
Planeación & 296 & 691 & 770 & 822 & 655 & 660 & 647 & 601 & 604 & 577 & 513 & 239 & 152 & 87 \\
    \bottomrule
  \end{tabularx}
\end{tabladoradoCorto}
\vspace{-4pt}
...
\begin{tabladoradoCorto}
  ...
  \begin{tabularx}{\textwidth}{Vvvvvv}
    \toprule
    \rowcolor{gobmxDorado} \encabezadodorado{MMBPCE} & \encabezadodorado{2026} & \encabezadodorado{2027} & \encabezadodorado{2028} & \encabezadodorado{2029} & \encabezadodorado{2030} \\
    \midrule
    Incorporación de reservas 3P por descubrimiento & 296 & 691 & 770 & 822 & 655 \\
    \bottomrule
  \end{tabularx}
\end{tabladoradoCorto}
\vspace{-4pt}
...
\begin{tabladoradoCorto}
  ...
  \begin{tabularx}{\textwidth}{Vvvvvv}
    \toprule
    \rowcolor{gobmxDorado} \encabezadodorado{PROYECTO} & \encabezadodorado{ÁREA 
KM2} & \encabezadodorado{UBICACIÓN} & \encabezadodorado{PRODUCCIÓN ACUMULADA} & \encabezadodorado{} & \encabezadodorado{PERIODO} \\
    \midrule
     &  &  & ACEITE 
MMB & GAS 
MMMPC &  \\
    Zama & 26.6 & Aguas Someras & 194 & 76 & 2027-2045 \\
    Trión & 36.7 & Aguas Profundas & 103 & 114 & 2028-2035 \\
    \bottomrule
  \end{tabularx}
\end{tabladoradoCorto}
\vspace{-4pt}
...
Se proponen 21 proyectos de desarrollo mixto: 9 terrestres, 9 en aguas someras y 3 en aguas profundas. De estos, 10 ya cuentan con asignaciones de desarrollo mixto aprobadas y uno se encuentra en proceso (Tabla 4.3). Los 10 proyectos en preparación son: Miquetla, Pánuco, Arenque, Xikin, Tetl, Tlacame, Ayatsil, Casquete de gas Akal, Exploratus y Cratos.
...
\begin{tabladoradoCorto}
  ...
  \begin{tabularx}{\textwidth}{Vvvvvvvvv}
    \toprule
    \rowcolor{gobmxDorado} \encabezadodorado{PROYECTO} & \encabezadodorado{ÁREA
KM2} & \encabezadodorado{UBICACIÓN} & \encabezadodorado{VOLUMEN A RECUPERAR} & \encabezadodorado{} & \encabezadodorado{MAX DE PRODUCCIÓN} & \encabezadodorado{} & \encabezadodorado{PERIODO} & \encabezadodorado{ESTATUS} \\
    \midrule
     &  &  & ACEITE
MMB & GAS
MMMPC & ACEITE
MMBD & GAS
MMMPCD &  &  \\
    Agua Fría & 176 & Terrestre & 102.9 & 151.1 & 18.33 & 25.86 & 2026-2045 & Adjudicado \\
    Cuervito & 536 & Terrestre &  & 244.2 &  & 72.84 & 2026-2045 & Adjudicado \\
    Macavil & 26 & Terrestre & 27.5 & 393.2 & 14.72 & 141.89 & 2026-2045 & Aprobado \\
    Nobilis
Maximino & 1509 & Aguas 
ultra profundas & 253.1 & 565.4 & 118.11 & 14.58 & 2026-2041 & Aprobado \\
    Pit – Kayab-
Utsil & 128 & Aguas 
Someras & 827.7 & 94.3 & 201.6 & 12 & 2026-2045 & Aprobado \\
    Sejkan – 
Tlatitok Sur & 23 & Aguas 
Someras & 40.9 & 77.4 & 33.71 & 33.62 & 2026-2034 & Aprobado \\
    Sini – Caparroso –
Pijije – Escuintle & 77 & Aguas 
Someras & 28.7 & 72.4 & 16.08 & 42.08 & 2026-2040 & Adjudicado \\
    Tamaulipas 
Constituciones & 102 & Terrestre & 78.9 & 96.1 & 18.69 & 22.82 & 2026-2045 & Adjudicado \\
    Tupilco Terciario & 80 & Terrestre & 6.9 & 3.2 & 3.25 & 1.54 & 2026-2045 & Adjudicado \\
    Macuil – Paki & 32 & Aguas 
Someras & 42.2 & 34.8 & 19.62 & 14.58 & 2026-2043 & Aprobado \\
    Rabasa & 96 & Terrestre & 18.4 & 15.7 & 6.26 & 5.15 & 2026-2040 & Aprobado \\
    Cinco Presidentes- Rodador & 92 & Terrestre & 22.2 & 18.6 & 5.61 & 7.47 & 2026-2043 & Aprobado \\
    San Ramón & 26 & Terrestre & 6.9 & 6.0 & 2.54 & 2.77 & 2026-2040 & Aprobado \\
    Madrefil – 
Bellota & 122 & Terrestre & 35.7 & 110.7 & 19.64 & 47.91 & 2026-2035 & Aprobado \\
    \bottomrule
  \end{tabularx}
\end{tabladoradoCorto}
\vspace{-4pt}
...
\begin{tabladoradoCorto}
  ...
  \begin{tabularx}{\textwidth}{Vvvvvv}
    \toprule
    \rowcolor{gobmxDorado} \encabezadodorado{PROYECTO} & \encabezadodorado{UBICACIÓN} & \encabezadodorado{ACTIVIDAD FÍSICA} & \encabezadodorado{VOLUMEN A RECUPERAR} & \encabezadodorado{} & \encabezadodorado{PERIODO} \\
    \midrule
     &  &  & ACEITE
MMB & GAS
MMMPC &  \\
    Ixachi & Terrestre & 41 Perforaciones de pozos & 400.0 & 3118.0 & 2025-2035 \\
    Lakach  & Aguas Profundas & 4 Perforaciones de pozos
1 Reparación Mayor &  & 660.0 & 2026-2035 \\
    \bottomrule
  \end{tabularx}
\end{tabladoradoCorto}
\vspace{-4pt}
...
\begin{tabladoradoLargo}
  ...
  \begin{xltabular}{\textwidth}{QZ}
    ...
    \toprule
    \rowcolor{gobmxDorado} \encabezadodorado{PERFORACIÓN DE POZOS} & \encabezadodorado{\SENERVHeader{ESCENARIO}} \\
    \midrule
    \endfirsthead
...
\begin{tabladoradoLargo}
  ...
  \begin{xltabular}{\textwidth}{QZ}
    ...
    \toprule
    \rowcolor{gobmxDorado} \encabezadodorado{CONSTRUCCIÓN 
DE INFRAESTRUCTURA} & \encabezadodorado{\SENERVHeader{UBICACiÓN}} \\
    \midrule
    \endfirsthead
...
\begin{figure}[H]
  {\centering
  % Texto alternativo para accesibilidad
  \pdftooltip{\includegraphics[width=1.0\textwidth]{img/figura_4_3.png}}{Figura 4.3. Programa de rehabilitación de los CPQ}
  \par}
  \raggedright
  \caption{Figura 4.3. Programa de rehabilitación de los CPQ}
...
Los planes de rehabilitación del CPQ Cosoleacaque, comprenden el sistema de almacenamiento y distribución en la Terminal de Almacenamiento y Servicios Portuarios (TASP) Pajaritos, así como la rehabilitación de las plantas de Amoniaco VI y VII en el CPQ Cosoleacaque. Con lo anterior, se espera incrementar la producción a 957 Mt para el año 2028, lo que representará un ingreso estimado de 11,381 millones de pesos (Tabla 4.9).
...
● Operación de dos plantas de Óxido de Etileno (Cangrejera y Morelos).

● Puesta en marcha de un tren de producción de Polietileno de Baja Densidad (PEBD).

● Inicio de operación de la planta Swing.

● Operación de dos trenes adicionales de PEBD.

● Rehabilitación y operación de la planta Mitsui para producción de glicoles.

● Rehabilitación y operación de la planta Asahi.

● Operación del tercer tren de PEBD.

Con estas acciones, se prevé incrementar la producción de 176 Mt en 2025 a 1,029 Mt a partir de 2030 en los CPQ Cangrejera y Morelos, lo que generará ingresos estimados de 20,496 millones de pesos (Tabla 4.9).
...
● Tanques de almacenamiento de naftas y LPG.

● Módulo para incremento de capacidad de procesamiento de gas.

● Torre de enfriamiento.

● Islas de llenado para naftas y LPG.
...
La CFE, mediante proyectos de infraestructura gasífera en desarrollo y planeación, busca fortalecer el suministro de gas natural en diversas regiones del país, para atender la creciente demanda energética. En la Tabla 4.13 se describen los principales proyectos de la Empresa Pública del Estado para la construcción de gasoductos y sus características.
...
● La construcción del gasoducto denominado Coatzacoalcos II garantizará el suministro seguro, continuo y confiable de gas natural al Polo de Desarrollo del mismo nombre, además de atender la demanda incremental de la zona.

● La Interconexión Cosoleacaque brindará condiciones de seguridad, continuidad, calidad y eficiencia en la prestación de servicios de transporte de gas natural, así como beneficios sistémicos de redundancia y flexibilidad operativa. Adicionalmente, este proyecto contribuye a dar redundancia al suministro a la Península de Yucatán.

● El proyecto de Rehabilitación M3 permitirá aprovechar la capacidad de importación en la zona norte a través de la reconfiguración del medidor denominado “M3”. Con esto, se incrementará la capacidad de transporte en la zona de Monterrey, mejorará las condiciones de continuidad y seguridad operativa en la zona y diversificará las fuentes de suministro.

● La Interconexión Ramones Fase II Sur contribuirá a mantener el balance y la operación del SISTRANGAS, así como a la flexibilidad operativa.

● El proyecto de Gasoducto Arco Tula incrementará la capacidad de transporte hacia la zona de Tula para robustecer el suministro de gas natural a los sectores eléctrico y petrolero, al tiempo que se contará con flexibilidad operativa en las zonas centro-occidente.
...
\begin{tabladoradoCorto}
  ...
  \begin{tabularx}{\textwidth}{Vvvv}
    \toprule
    \rowcolor{gobmxDorado} \encabezadodorado{NO.} & \encabezadodorado{ESTRATEGIA} & \encabezadodorado{OBJETIVO} & \encabezadodorado{ALCANCE} \\
    \midrule
    1 & SUMINISTRO DE GAS NATURAL A LOS POLOS DE DESARROLLO & Establecer soluciones de abastecimiento de gas natural que permitan garantizar el suministro confiable y eficiente a los polos de desarrollo. & Como primera fase de la estrategia se evaluarán proyectos de infraestructura de transporte de gas natural para Parque Bajío, en Michoacán: 1) gasoducto paralelo, 2) instalación de una EC. \\
    2 & ALMACENAMIENTO DE GAS NATURAL & Promover el desarrollo de infraestructura de almacenamiento de gas natural a fin de constituir inventarios estratégicos y operativos gestionados por el Estado. & Alinear los elementos técnicos, económicos y regulatorios necesarios para viabilizar proyectos de almacenamiento que permitan la creación de inventarios estratégicos de gas natural. \\
    \bottomrule
  \end{tabularx}
\end{tabladoradoCorto}
\vspace{-4pt}
...
\begin{tabladoradoCorto}
  ...
  \begin{tabularx}{\textwidth}{Vvvvv}
    \toprule
    \rowcolor{gobmxDorado} \encabezadodorado{PROYECTO} & \encabezadodorado{UBICACIÓN} & \encabezadodorado{ALCANCES} & \encabezadodorado{AÑO DE INICIO DE OPERACIONES} & \encabezadodorado{ALCANCE} \\
    \midrule
    GASODUCTO LIBRAMIENTO REYNOSA & Reynosa, Tamaulipas & Construcción de un gasoducto de 24 pulgadas de diámetro y 58.3 kilómetros y modernización de las estaciones de medición y control Terminal 2, Estación 19. & Primer semestre del 2026 & En 6 Residencias Regionales.
EC: Pátzcuaro, Cempoala, Sta. Catarina, Reynosa, Chávez, Chinameca, así como Jáltipan, Medias Aguas y Donají \\
    ESTACIÓN DE COMPRESIÓN CHINAMECA & Chinameca, Veracruz & Rehabilitación y modernización de una estación de compresión bidireccional en Chinameca, conectada al gasoducto de 48” Cactus-San Fernando. & Primer semestre del 2026 & En 12 Residencias Regionales.
 \\
    ESTACIONES DE COMPRESIÓN JÁLTIPAN, MEDIAS AGUAS Y DONAJÍ & Corredor Interoceánico del Istmo, Veracruz y Oaxaca & Rehabilitación de los sistemas de control, gas y fuego, sistemas eléctricos, infraestructura civil y mecánica, para las estaciones. & Primer semestre del 2026 & En 13 Residencias Regionales.
 \\
    \bottomrule
  \end{tabularx}
\end{tabladoradoCorto}
...
\begin{tabladoradoCorto}
  ...
  \begin{tabularx}{\textwidth}{Vvvv}
    \toprule
    \rowcolor{gobmxDorado} \encabezadodorado{PROYECTO} & \encabezadodorado{CARACTERÍSTICAS} & \encabezadodorado{INICIO DE OPERACIÓN} & \encabezadodorado{BENEFICIO} \\
    \midrule
     &  &  &  \\
    Refinería Salina Cruz & Central de cogeneración de 600-1,000 MW  y 645 toneladas de vapor por hora & 2030 & El proyecto permitirá una reducción estimada de 465 mil toneladas de emisiones de CO₂
por año \\
    Refinería Tula & Central de cogeneración de 794 MW y 984 toneladas de vapor por hora & 2030 & El proyecto permitirá una reducción estimada de 390 mil toneladas anuales de emisiones de CO₂ \\
    CPQ Cangrejera & Central de cogeneración de 900 MW y 750 toneladas de vapor por hora & 2030 & El proyecto permitirá una reducción estimada de 440 mil toneladas anuales de emisiones
de CO₂ \\
    \bottomrule
  \end{tabularx}
\end{tabladoradoCorto}
...
\begin{figure}[H]
  {\centering
  % Texto alternativo para accesibilidad
  \pdftooltip{\includegraphics[width=1.0\textwidth]{img/figura_4_4.png}}{Figura 4.4.  Iniciativas y medidas de eficiencia energética planificadas de 2026 a 2030}
  \par}
  \raggedright
  \caption{Figura 4.4.  Iniciativas y medidas de eficiencia energética planificadas de 2026 a 2030}
...
\begin{tabladoradoCorto}
  ...
  \begin{tabularx}{\textwidth}{Vvvvvvvv}
    \toprule
    \rowcolor{gobmxDorado} \encabezadodorado{Indicador} & \encabezadodorado{Unidades} & \encabezadodorado{2025} & \encabezadodorado{2026} & \encabezadodorado{2027} & \encabezadodorado{2028} & \encabezadodorado{2029} & \encabezadodorado{2030} \\
    \midrule
    ICE Extracción y Producción1 & GJ/Mbpce & 167.41 & 164.89 & 162.42 & 161.61 & 160.80 & 160.00 \\
    ICE Refinerías2 & GJ/Mb & 684.72 & 674.45 & 664.33 & 661.01 & 657.70 & 654.41 \\
    ICE CPG´s & GJ/MMpc & 53.09 & 52.30 & 51.51 & 51.25 & 51.00 & 50.74 \\
    ICE CPQ´s3 & GJ/t & 111.53 & 109.85 & 108.21 & 107.67 & 107.13 & 106.60 \\
    \bottomrule
  \end{tabularx}
\end{tabladoradoCorto}
\vspace{-4pt}
...
\begin{tabladoradoCorto}
  ...
  \begin{tabularx}{\textwidth}{Vvvv}
    \toprule
    \rowcolor{gobmxDorado} \encabezadodorado{PROYECTO} & \encabezadodorado{OBJETIVO} & \encabezadodorado{FIRMA DE CONTRATO/ INICIO DE INVERSIÓN} & \encabezadodorado{INICIO DE OPERACIÓN} \\
    \midrule
    Electromovilidad & Impulsar la estrategia nacional de electromovilidad y su infraestructura mediante la colaboración público-privada, promoviendo la adopción de vehículos eléctricos y el crecimiento del mercado de unidades ligeras y pesadas. & 2026 & 2026 \\
    Granjas solares: Energía eléctrica renovable & La implementación de techos solares permitirán reducir costos energéticos, mejora de la imagen, así como, reducción de las emisiones de gases efecto invernadero. Proyectos en instalaciones propiedad de Pemex & 2026 & 2026 \\
    Extracción de litio de salmueras & Aprovechar la extracción de salmuera petrolera, que hoy se considera un costo, para extraer minerales disueltos como el litio. & 2029 & 2029 \\
    Producción sostenible de SAF & La producción nacional de biocombustibles busca fortalecer la independencia energética del país lo que permite diversificar la matriz incorporando fuentes renovables y reducir la dependencia de combustibles fósiles además contribuye a cumplir compromisos internacionales en sostenibilidad y transición hacia energías limpias & 2026 & 2030 \\
    Producción de Hidrógeno Verde & Impulsar la producción e integración del hidrógeno verde en México, posicionando al país no solo como consumidor interno, sino también como exportador estratégico de energía limpia hacia América del Norte, Europa y Asia, aprovechando su potencial renovable y costos competitivos. & 2027 & 2030 \\
    Generación de energía eólica & Generación de energía eólica en plataformas petroleras en desuso. & 2027 & 2031 \\
    Generación energía solar & Proyectos de generación distribuida solar fotovoltaica (FV) para autoconsumo en gasolineras, considerando sistemas interconectados de aproximadamente 35 kWp.
 & 2025 & En Planeación \\
    Combustión del coque, generación de electricidad & Aprovechar el coque para generar energía eléctrica destinada al Mercado Eléctrico Mayorista, implementar tecnologías de captura de dióxido de carbono y promover la economía circular transformando residuos en productos de alto valor. & 2030 &  \\
    Diésel ecológico & Reducir la peligrosidad de los productos de PEMEX conforme a requerimientos legales ambientales o de comercio internacional, como es el caso de la reducción del contenido de azufre en el diésel. Por ello se agregó un nuevo producto denominado Pemex Diésel Ecológico con 10 ppm máximo de azufre. &  & 2025 \\
    \bottomrule
  \end{tabularx}
\end{tabladoradoCorto}
\vspace{-4pt}
...
En cuanto al aprovechamiento de gas natural y calor, se contemplan 3 proyectos; uno enfocado al aprovechamiento del calor del Campo Ixachi; dos enfocados al aprovechamiento de gas natural, tanto en los procesos de extracción de hidrocarburos como en los procesos de transformación (Tabla 4.20).

El Proyecto de Aprovechamiento del Calor en Ixachi, tiene como finalidad implementar sistemas de recuperación térmica mediante intercambiadores de calor y ciclos termodinámicos adaptados a las condiciones del yacimiento Ixachi. Se busca capturar el calor residual generado en la producción de hidrocarburos —principalmente en cabezales y separadores— para su integración en procesos industriales como precalentamiento de corrientes, generación de vapor o cogeneración eléctrica. Esta estrategia permite reducir la entropía del sistema operativo, optimizar el balance energético del sitio y disminuir la necesidad de fuentes externas de energía térmica.

El Plan de Aprovechamiento de Gas, en la Terminal Marítima de Dos Bocas (TMDB), contempla el desarrollo de proyectos enfocados al uso integral del gas natural disponible en las instalaciones. El plan incluye la obtención de valiosos líquidos asociados al gas, la maximización de la generación de energía eléctrica y el aprovechamiento del calor residual. Con ello, se pretende incrementar la eficiencia energética de los sistemas y reducir las emisiones fugitivas; en línea con los objetivos de sustentabilidad y aprovechamiento óptimo de los recursos.

El Programa de Aprovechamiento de Gas Natural, busca evitar su Quema y Venteo e implementar sistemas para la recuperación y utilización del gas de desecho, generado en campos de producción, refinerías y plantas de procesamiento de gas. Este gas, será destinado a la generación de energía eléctrica, promoviendo la reducción de emisiones y el uso sustentable de los recursos naturales. Adicionalmente, el programa incluye el desarrollo de sistemas de recolección y acondicionamiento de gas natural fuera de especificación, a fin de incorporarlo a los procesos de generación eléctrica, considerando esquemas de transferencia y optimización del gasto energético.
...
\begin{tabladoradoCorto}
  ...
  \begin{tabularx}{\textwidth}{Vvvv}
    ...
    \rowcolor{gobmxDorado} \encabezadodorado{PROYECTO} & \encabezadodorado{OBJETIVO} & \encabezadodorado{FIRMA DE CONTRATO/ INICIO DE INVERSIÓN} & \encabezadodorado{INICIO DE OPERACIÓN} \\
    \midrule
    Aprovechamiento del calor en Ixachi & Aprovechamiento de calor de los pozos petroleros en Ixachi. & 2026 & 2027 \\
    Aprovechamiento de gas en TMDB & Aprovechar el gas natural de la Terminal Marítima de Dos Bocas (TMDB) para obtención de líquidos valiosos asociados al gas, maximizar la generación de energía eléctrica y el aprovechamiento del calor. & 2026 & 2027 \\
    Aprovechamiento de gas natural evitando su quema venteo & Aprovechar el gas de desecho en campos de producción refinerías y plantas de gas, Destinarlo a la generación de energía eléctrica & 2026 & 2027 \\
    \bottomrule
  \end{tabularx}
\end{tabladoradoCorto}
\vspace{-4pt}
...
\begin{tabladoradoCorto}
  ...
  \begin{tabularx}{\textwidth}{Vvvvvvv}
    \toprule
    \rowcolor{gobmxDorado} \encabezadodorado{PROYECTO} & \encabezadodorado{2025} & \encabezadodorado{2026} & \encabezadodorado{2027} & \encabezadodorado{2028} & \encabezadodorado{2029} & \encabezadodorado{2030} \\
    \midrule
    EXPLORACIÓN y EXTRACCIÓN (tCO2e/Mbpce) & 21.5 & 20.7 & 19.9 & 19.1 & 18.3 & 17.5 \\
    PROCESO DE GAS (tCO2e/MMpc) & 4.3 & 4.3 & 4.2 & 4.1 & 4.0 & 3.9 \\
    REFINACIÓN (tCO2e/Mb) & 39.7 & 38.7 & 37.8 & 36.9 & 36.0 & 35.1 \\
    \bottomrule
  \end{tabularx}
\end{tabladoradoCorto}
\vspace{-4pt}
...
● Impulsar la reducción de emisiones de GEI mediante la incorporación de fuentes de energía renovables y limpias, en el desarrollo de sus actividades empresariales, económicas, industriales y comerciales en términos de su objeto, aportando una capacidad instalada de 7,143MW a través del desarrollo de nuevos proyectos (Centrales de Generación de Energía Eólica y Centrales Fotovoltaicas).

● La transición hacia una economía baja en carbono y el cumplimiento de los acuerdos internacionales suscritos por México.

● Atención y mitigación de impactos sociales asociados a la cadena de valor y a los actores de interés.
...
● NIIF S1: Requerimientos Generales para la Información Financiera a Revelar relacionada con la Sostenibilidad.
...
● La incorporación de energías limpias en la generación eléctrica.
...
● La sustitución de combustibles de alto contenido de carbono por gas en centrales de alta eficiencia.
...
\entradaGlosario{km2}{Kilómetros cuadrados}
...
\entradaGlosario{MMm3}{Millones de metros cúbicos}
