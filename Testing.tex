...
\hypersetup{
  ...
  pdfcreationdate={D:20260204183156},
  pdfversion={1}
}
...
\begin{figure}[H]
  ...
  \pdftooltip{\includegraphics[width=1.0\textwidth]{img/figura_2_1.png}}{Figura 1.1 Principal infraestructura del sector hidrocarburos, 2024}
  \par}
  \raggedright
